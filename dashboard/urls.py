...
from .views import (DashboardView, KPIDetailView, Ibyakozwe, DistrictChartView,
                    ...
                    SearchResultsView, All_Kpi_PerSector_Chart, load_sectors, UpdateFamily, DeleteFamily)
...
urlpatterns = [
    ...
    path('ajax/load-sector/', load_sectors, name='ajax_load_sector'),
    path('ajax/load-cells/', load_cells, name='ajax_load_cells'),
    path('ajax/load-villages/', load_village, name='ajax_load_villages'),


    path('update/<int:pk>/', UpdateFamily.as_view(), name='updatefam'),
    path('delete/<int:pk>/', DeleteFamily.as_view(), name='deletefam'),
]